...
# On cherche à maximiser la valeur finale
...
class Fractionnaire:
    ...
    def ValeurMax(p, val, capacite):
        ...
        # On ordonne dans l'ordre decroissant les objets selon leur valeurs
...
if __name__ == "__main__":
    ...
    maxValue = Fractionnaire.ValeurMax(poids, valeurs, capacite)
